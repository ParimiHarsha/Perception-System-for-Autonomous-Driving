...
gnome-terminal --tab --title="YOLOv9 Object Detection" -- bash -c 'source /home/dev/miniconda3/etc/profile.d/conda.sh && 
...
gnome-terminal --tab --title="SAM2 Segmentation" -- bash -c 'source /home/dev/miniconda3/etc/profile.d/conda.sh && 
...
gnome-terminal --tab --title="Sphereformer Lidar Segmentation" -- bash -c 'source /home/dev/miniconda3/etc/profile.d/conda.sh && 
